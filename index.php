...
rappresenta la connessione con il DB. Se non ci riesce non restituisce nulla
    ...
    Ovviamente deve esitere un DB $database sul server $userName, deve esistere un utente di nome "utentecorsophp" con password "password" (quando mi impegno riesco a creare password difficilissime)
...
<html>
    ...
    <body>
        ...
        if(isset($COOKIE["LOGIN"])){
                    ...
                    echo"<p>Benvenuto ".isset($COOKIE["LOGIN"])."</p>";
